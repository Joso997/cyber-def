...
class FieldButtonComponent extends FormComponentAbstract
{
    ...
    public function __construct(string $label, string $tag, $elementType = ""){
        ...
        parent::__construct($label, $tag,RegionsEnum::Form, ObjectsEnum::FieldButton,  SubObjectsEnum::ParentObject, ActionsEnum::None);
    }
